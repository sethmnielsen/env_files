...
if("TRUE" STREQUAL "TRUE")
  set(rosflight_SOURCE_PREFIX /home/seth/dev/ws/src/rosflight/rosflight)
  set(rosflight_DEVEL_PREFIX /home/seth/dev/ws/devel)
  ...
  set(rosflight_INSTALL_PREFIX /home/seth/dev/ws/install)
...
if(NOT "/home/seth/dev/ws/src/rosflight/rosflight/include;/usr/include;/usr/local/include/eigen3 " STREQUAL " ")
  set(rosflight_INCLUDE_DIRS "")
  set(_include_dirs "/home/seth/dev/ws/src/rosflight/rosflight/include;/usr/include;/usr/local/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosflight' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/seth/dev/ws/src/rosflight/rosflight/${idir}'.  ${_report}")
    endif()

...
if("TRUE" STREQUAL "TRUE")
  set(rosflight_utils_SOURCE_PREFIX /home/seth/dev/ws/src/rosflight/rosflight_utils)
  set(rosflight_utils_DEVEL_PREFIX /home/seth/dev/ws/devel)
  ...
  set(rosflight_utils_INSTALL_PREFIX /home/seth/dev/ws/install)
...
if(NOT "/home/seth/dev/ws/src/rosflight/rosflight_utils/include " STREQUAL " ")
  set(rosflight_utils_INCLUDE_DIRS "")
  set(_include_dirs "/home/seth/dev/ws/src/rosflight/rosflight_utils/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosflight_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/seth/dev/ws/src/rosflight/rosflight_utils/${idir}'.  ${_report}")
    endif()
